...
classdef nbt_PeakFit < nbt_SignalBiomarker
    ...
    methods
        function BiomarkerObject = nbt_PeakFit(NumChannels)
            ...
            BiomarkerObject.biomarkerType = {'nbt_SignalBiomarker','nbt_SignalBiomarker', 'nbt_SignalBiomarker','nbt_SignalBiomarker', 'nbt_SignalBiomarker','nbt_SignalBiomarker','nbt_SignalBiomarker',...
